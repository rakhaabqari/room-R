// Variable to change:
var baseBetAmount = 0.00000004; // The base amount that you want to bet.
...
var maxGain = 0.00002; // The scripts stop when a maximum number of satoshi have benn earned.
